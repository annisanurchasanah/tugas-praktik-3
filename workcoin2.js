const { workChain } = require("./workchain");
...
const privateKey = "436c1ca4fb507757001282651348de24f55b6aba2211ce3613ce74b1ec019a0b";
...
setTimeout(() => {
    if (workChain.transactions.length !== 0){
        workChain.mineTransaction(publickey);

        sendMessage(produceMessage("TYPE_REPLACE_CHAIN", [
            workChain.getLastblock(),
            workChain.difficulty
